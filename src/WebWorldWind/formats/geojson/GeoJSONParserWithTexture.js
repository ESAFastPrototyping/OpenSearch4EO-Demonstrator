...
const ArgumentError = WorldWind.ArgumentError,
    ...
    GeoJSONGeometryMultiPoint = WorldWind.GeoJSONGeometryMultiPoint,
    GeoJSONGeometryMultiPolygon = WorldWind.GeoJSONGeometryMultiPolygon,
    GeoJSONGeometryPoint = WorldWind.GeoJSONGeometryPoint,
    GeoJSONGeometryPolygon = WorldWind.GeoJSONGeometryPolygon,
    ...
    SurfacePolyline = WorldWind.SurfacePolyline;

/**
 * Constructs a GeoJSON object for a specified GeoJSON data source. Call [load]{@link GeoJSONParserWithTexture#load} to
 * retrieve the GeoJSON and create shapes for it.
 * @alias GeoJSONParserWithTexture
 * @constructor
...
Object.defineProperties(GeoJSONParserWithTexture.prototype, {
    /**
     * The GeoJSON data source as specified to this GeoJSON's constructor.
     * @memberof GeoJSONParserWithTexture.prototype
     * @type {String}
     * @readonly
     */
    dataSource: {
    ...
    /** The completion callback specified to [load]{@link GeoJSONParserWithTexture#load}. An optional function called when
    ...
    /**
     * The attribute callback specified to [load]{@link GeoJSONParserWithTexture#load}.
     * See that method's description for details.
     * @memberof GeoJSONParserWithTexture.prototype
     * @type {Function}
     * @default [defaultShapeConfigurationCallback]{@link GeoJSONParserWithTexture#defaultShapeConfigurationCallback}
     * @readonly
     */
 ...
 * <ul>
 *     <li>[addRenderablesForPoint]{@link GeoJSONParserWithTexture#addRenderablesForPoint}</li>
 *     <li>[addRenderablesForMultiPoint]{@link GeoJSONParserWithTexture#addRenderablesForMultiPoint}</li>
 *     <li>[addRenderablesForLineString]{@link GeoJSONParserWithTexture#addRenderablesForLineString}</li>
 *     <li>[addRenderablesForMultiLineString]{@link GeoJSONParserWithTexture#addRenderablesForMultiLineString}</li>
 *     <li>[addRenderablesForPolygon]{@link GeoJSONParserWithTexture#addRenderablesForPolygon}</li>
 *     <li>[addRenderablesForMultiPolygon]{@link GeoJSONParserWithTexture#addRenderablesForMultiPolygon}</li>
 *     <li>[addRenderablesForGeometryCollection]{@link GeoJSONParserWithTexture#addRenderablesForGeometryCollection}</li>
 *     <li>[addRenderablesForFeature]{@link GeoJSONParserWithTexture#addRenderablesForFeature}</li>
 *     <li>[addRenderablesForFeatureCollection]{@link GeoJSONParserWithTexture#addRenderablesForFeatureCollection}</li>
 * </ul>
 *
 * @param {RenderableLayer} layer A {@link RenderableLayer} to hold the shapes created for each GeoJSON
 * geometry. If null, a new layer is created and assigned to this object's [layer]{@link GeoJSONParserWithTexture#layer}
 * property.
 */

GeoJSONParserWithTexture.prototype.load = function (parserCompletionCallback, shapeConfigurationCallback, layer) {
...
/**
 * The default [shapeConfigurationCallback]{@link GeoJSONParserWithTexture#shapeConfigurationCallback} for this GeoJSON.
 * It is called if none was specified to the [load]{@link GeoJSONParserWithTexture#load} method.
 ...
 */
GeoJSONParserWithTexture.prototype.defaultShapeConfigurationCallback = function (geometry, properties) {
    var configuration = {};
...
GeoJSONParserWithTexture.prototype.requestUrl = function (url) {
...
GeoJSONParserWithTexture.prototype.parse = function (geoJSONString) {
    try {
...
// Internal use only.
GeoJSONParserWithTexture.prototype.setGeoJSONCRS = function () {
 ...
 * [shapeConfigurationCallback]{@link GeoJSONParserWithTexture#shapeConfigurationCallback}:
 * <ul>
 *     <li>[addRenderablesForGeometry]{@link GeoJSONParserWithTexture#addRenderablesForGeometry}</li>
 *     <li>[addRenderablesForGeometryCollection]{@link GeoJSONParserWithTexture#addRenderablesForGeometryCollection}</li>
 *     <li>[addRenderablesForFeature]{@link GeoJSONParserWithTexture#addRenderablesForFeature}</li>
 *     <li>[addRenderablesForFeatureCollection]{@link GeoJSONParserWithTexture#addRenderablesForFeatureCollection}</li>
 * </ul>
 ...
 */
GeoJSONParserWithTexture.prototype.addRenderablesForGeoJSON = function (layer) {
    if (!layer) {
        throw new ArgumentError(
 ...
 */
GeoJSONParserWithTexture.prototype.addRenderablesForGeometry = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * [addRenderablesForGeometry]{@link GeoJSONParserWithTexture#addRenderablesForGeometry}.
 * <p>
 * This method invokes this GeoJSON's
 * [shapeConfigurationCallback]{@link GeoJSONParserWithTexture#shapeConfigurationCallback} for the geometry.
 * @param {RenderableLayer} layer The layer in which to place the newly created shapes.
 ...
 */
GeoJSONParserWithTexture.prototype.addRenderablesForPoint = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * @throws {ArgumentError} If the specified geometry is null or undefined.
 */
GeoJSONParserWithTexture.prototype.addRenderablesForMultiPoint = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * @throws {ArgumentError} If the specified geometry is null or undefined.
 */
GeoJSONParserWithTexture.prototype.addRenderablesForLineString = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * @throws {ArgumentError} If the specified geometry is null or undefined.
 */
GeoJSONParserWithTexture.prototype.addRenderablesForMultiLineString = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * @throws {ArgumentError} If the specified geometry is null or undefined.
 */
GeoJSONParserWithTexture.prototype.addRenderablesForPolygon = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * @throws {ArgumentError} If the specified geometry is null or undefined.
 */
GeoJSONParserWithTexture.prototype.addRenderablesForMultiPolygon = function (layer, geometry, properties) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * Applications typically do not call this method directly. It is called by
 * [addRenderablesForGeoJSON]{@link GeoJSONParserWithTexture#addRenderablesForGeoJSON}.
 * @param {RenderableLayer} layer The layer in which to place the newly created shapes.
 ...
 */
GeoJSONParserWithTexture.prototype.addRenderablesForGeometryCollection = function (layer, geometryCollection, properties) {
    if (!layer) {
        throw new ArgumentError(
...
/**
 * Calls [addRenderablesForGeometry]{@link GeoJSONParserWithTexture#addRenderablesForGeometry} or
 * [addRenderablesForGeometryCollection]{@link GeoJSONParserWithTexture#addRenderablesForGeometryCollection}
 ...
 */
GeoJSONParserWithTexture.prototype.addRenderablesForFeature = function (layer, feature) {
    if (!layer) {
        throw new ArgumentError(
 ...
 * @throws {ArgumentError} If the specified featureCollection is null or undefined.
 */
GeoJSONParserWithTexture.prototype.addRenderablesForFeatureCollection = function (layer, featureCollection) {
    if (!layer) {
        throw new ArgumentError(
...
GeoJSONParserWithTexture.prototype.setGeoJSONType = function () {
 ...
 */
GeoJSONParserWithTexture.prototype.getReprojectedIfRequired = function (latitude, longitude, crsObject) {
...
GeoJSONParserWithTexture.prototype.setProj4jsAliases = function () {
    Proj4.defs([
        [
 ...
 */
GeoJSONParserWithTexture.prototype.isDataSourceJson = function () {
    try {
...
export default GeoJSONParserWithTexture;
