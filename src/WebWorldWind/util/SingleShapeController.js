 ...
 */
var SingleShapeEditorController = function (worldWindow, shapeID) {
    if (!worldWindow) {
 ...
 */
SingleShapeEditorController.prototype.setArmed = function (armed) {
    if (!this.armed && armed) {
        this.enable();
    }
...
/**
 * Called by {@link SingleShapeEditorController#setArmed} to initialize this editor.
 */
SingleShapeEditorController.prototype.enable = function () {
...
/**
 * Called by {@link SingleShapeEditorController#setArmed} to remove resources no longer needed after editing.
 */
SingleShapeEditorController.prototype.disable = function () {
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.formatLatitude = function (number) {
    var suffix = number < 0 ? "\u00b0S" : "\u00b0N";
    return Math.abs(number).toFixed(4) + suffix;
};

//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.formatLongitude = function (number) {
    var suffix = number < 0 ? "\u00b0W" : "\u00b0E";
    return Math.abs(number).toFixed(4) + suffix;
};

//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.formatLength = function (number) {
    var suffix = " km";
    return Math.abs(number / 1000.0).toFixed(3) + suffix;
};

//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.formatRotation = function (rotation) {
 ...
 */
SingleShapeEditorController.prototype.updateControlPoints = function () {
 ...
 */
SingleShapeEditorController.prototype.removeControlPoints = function () {
 ...
 */
SingleShapeEditorController.prototype.doMakeShadowShape = function () {
 ...
 */
SingleShapeEditorController.prototype.makeShadowShape = function () {
 ...
 */
SingleShapeEditorController.prototype.removeShadowShape = function () {
 ...
 */
SingleShapeEditorController.prototype.makeAnnotation = function () {
 ...
 */
SingleShapeEditorController.prototype.updateShapeAnnotation = function () {
 ...
 */
SingleShapeEditorController.prototype.removeAnnotation = function () {
 ...
 */
SingleShapeEditorController.prototype.makeControlPointAttributes = function () {
 ...
 */
SingleShapeEditorController.prototype.makeAccessory = function () {
    var pathPositions = [];
 ...
 */
SingleShapeEditorController.prototype.removeAccessory = function () {
 ...
 * @param {Event} event
 */
SingleShapeEditorController.prototype.dragWholeShape = function (event) {
 ...
 */
SingleShapeEditorController.prototype.reshapeShape = function (terrainObject) {
...
/**
 * Called by {@link SingleShapeEditorController#reshapeShape} to perform the actual shape modification.
 ...
 */
SingleShapeEditorController.prototype.doReshapeShape = function (controlPoint, terrainPosition) {
    if (this.shape && this.shape instanceof SurfaceShape) {
        if (this.shape instanceof SurfacePolygon ||
            this.shape instanceof SurfacePolyline
        ) {
 ...
 */
SingleShapeEditorController.prototype.getCenter = function (locations) {
    var count = 0;
 ...
 */
SingleShapeEditorController.prototype.getShapeCenter = function () {
    var center = null;
 ...
 */
SingleShapeEditorController.prototype.getAverageDistance = function (globe, center, locations) {
 ...
 */
SingleShapeEditorController.prototype.updateAnnotation = function (controlPoint) {
    if (!controlPoint) {
        this.annotationLayer.enabled = false;
        return;
    }
 ...
 */
SingleShapeEditorController.prototype.updateOrientationLine = function (centerPosition, controlPointPosition) {
 ...
 */
SingleShapeEditorController.prototype.computeControlPointDelta = function (previousPosition, currentPosition) {
 ...
 */
SingleShapeEditorController.prototype.normalizedHeading = function (originalHeading, deltaHeading) {
 ...
 */
SingleShapeEditorController.prototype.nearestPointOnSegment = function (p1, p2, point) {
 ...
 */
SingleShapeEditorController.prototype.addNearestLocation = function (terrainPosition, altitude, locations) {
    var globe = this.worldWindow.globe;
 ...
 */
SingleShapeEditorController.prototype.moveLocation = function (controlPoint, terrainPosition) {
 ...
 */
SingleShapeEditorController.prototype.rotateLocations = function (terrainPosition, locations) {
...
SingleShapeEditorController.prototype.setPreviousPosition = function (event) {
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.reshapeSurfacePolygon = function (controlPoint, terrainPosition) {
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.updateSurfacePolygonControlPoints = function () {
    var locations = [];
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.reshapeSurfaceCircle = function (controlPoint, terrainPosition) {
    if (!controlPoint) {
        return;
    }
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.updateSurfaceCircleControlPoints = function () {
    var circle = this.shape;
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.reshapeSurfaceRectangle = function (controlPoint, terrainPosition) {
    if (!controlPoint) {
        return;
    }
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.updateSurfaceRectangleControlPoints = function () {
    var rectangle = this.shape;
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.reshapeSurfaceEllipse = function (controlPoint, terrainPosition) {
    if (!controlPoint) {
        return;
    }
...
//Internal use only. Intentionally not documented.
SingleShapeEditorController.prototype.updateSurfaceEllipseControlPoints = function () {
    var ellipse = this.shape;
...
export default SingleShapeEditorController;